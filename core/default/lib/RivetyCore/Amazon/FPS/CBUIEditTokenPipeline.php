...
class RivetyCore_Amazon_FPS_CBUIEditTokenPipeline extends RivetyCore_Amazon_FPS_CBUIPipeline {
     ...
     */
    function RivetyCore_Amazon_FPS_CBUIEditTokenPipeline($awsAccessKey, $awsSecretKey) {
        parent::RivetyCore_Amazon_FPS_CBUIPipeline("EditToken", $awsAccessKey, $awsSecretKey);
    }
