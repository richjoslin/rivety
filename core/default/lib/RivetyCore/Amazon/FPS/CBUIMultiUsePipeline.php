...
class RivetyCore_Amazon_FPS_CBUIMultiUsePipeline extends RivetyCore_Amazon_FPS_CBUIPipeline {
     ...
     */
    function RivetyCore_Amazon_FPS_CBUIMultiUsePipeline($awsAccessKey, $awsSecretKey) {
        parent::RivetyCore_Amazon_FPS_CBUIPipeline("MultiUse", $awsAccessKey, $awsSecretKey);
    }
