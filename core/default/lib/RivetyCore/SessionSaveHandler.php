...
/*
	Class: RivetyCore_SessionSaveHandler
...
*/
class RivetyCore_SessionSaveHandler implements Zend_Session_SaveHandler_Interface {
	...
	*/
	public function destroy($id) {
		...
		RivetyCore_Log::info("Session handler: deleted session id " .$id);
	...
	*/
	public function gc($lifetime) {
		$sessions_table = new Sessions();
		$where = "expiration < " . time() - (int)RivetyCore_Registry::get('session_timeout');
		RivetyCore_Log::info("Session handler: deleted sessions: " .$where);
		//$sessions_table->delete($where);
	}
