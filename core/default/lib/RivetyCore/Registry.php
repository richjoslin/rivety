...
/*
	...
	About: See Also
		Zend_Registry
*/
class RivetyCore_Registry extends Zend_Registry {
	...
	*/
	public static function get($setting, $module = 'default')
	{
		...
		{			
			...
			if ($config_table->keyExists($module , $setting)) $value = $config_table->get($module, $setting);
		}
