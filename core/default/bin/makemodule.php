...
$template_dir = $basepath."/core/default/extras/makemodule_templates";
$module_dir = $basepath."/modules/".$module_name;
$frontend_theme_dir = $basepath."/themes/frontend/default/tpl_controllers/".$module_name;
$admin_theme_dir = $basepath."/themes/admin/default/tpl_controllers/".$module_name;
