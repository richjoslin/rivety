...
{else}
	<form method="post" action="/" class="multiform" enctype="multipart/form-data">
		...
		<div class="form-field">
			...
			{html_options name=rivety_timezone id=rivety_timezone options=$timezones selected=$rivety_timezone}
		</div>
		...
		<div class="form-field">
			...
			<input type="text" size="75" value="{$rivety_zf_path}" name="rivety_zf_path" id="rivety_zf_path" />
		</div>
		<div class="form-field">
			<label>Path to Smarty</label>
			<input type="text" size="75" value="{$rivety_smarty_path}" name="rivety_smarty_path" id="rivety_smarty_path" />
		</div>
		<div class="form-field">
			<label>Path to Asido</label>
			<input type="text" size="75" value="{$rivety_asido_path}" name="rivety_asido_path" id="rivety_asido_path" />
		</div>
		<div class="form-field">
