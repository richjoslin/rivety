...
VALUES
	(1, 0, 3, NULL, NULL, 'main', 'Main', NULL, 0),
	(2, 1, 3, NULL, NULL, 'main_home', 'Home', '/', 10),
	(6, 0, 3, NULL, NULL, 'admin_header', 'Admin', NULL, 0),
	(7, 6, 3, NULL, NULL, 'admin_dashboard', 'Dashboard', '/default/admin/index', 10),
	(8, 6, 3, NULL, NULL, 'admin_useradmin', 'Users', '/default/useradmin/index', 20),
	(9, 21, 3, NULL, NULL, 'admin_config', 'Config', '/default/config/index', 10),
	(10, 0, 2, NULL, NULL, 'main', 'Main', NULL, 0),
	(11, 10, 2, NULL, NULL, 'main_home', 'Home', '/', 10),
	(15, 0, 1, NULL, NULL, 'main', 'Main', NULL, 0),
	(16, 15, 1, NULL, NULL, 'main_home', 'Home', '/', 10),
	(21, 6, 3, NULL, NULL, 'admin_settings', 'Settings', NULL, 40),
	(22, 21, 3, NULL, NULL, 'admin_modules', 'Modules', '/default/module/index', 20),
	(24, 21, 3, NULL, NULL, 'admin_testdata', 'Load Test Data', '/default/useradmin/testdata', 40),
	(23, 21, 3, NULL, NULL, 'admin_roles', 'Roles', '/default/role/index', 30);
